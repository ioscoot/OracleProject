<%-- 
    Document   : UploadStire
    Created on : Apr 20, 2017, 3:24:12 PM
    Author     : oracle
--%>
...
<html>
    <head>
        ...
        <title>Încărcare știre nouă</title>
<style type="text/css">
...
<div class="">
	<div class="row">
		<h3 class="text-center ">Încărcare știre</h3> 
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Introduceți textul: </label>  
  <div class="col-md-6">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Introduceți o imagine:</label>  
  <div class="col-md-6">
  <input id="textinput" name="textinput" placeholder=" " class="form-control input-md" required="" type="text">
  <span class="help-block"> </span>  
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <button id="singlebutton" name="singlebutton" class="btn btn-success">Înregistrare</button>
  </div>
</div>
