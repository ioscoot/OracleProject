<%-- 
    Document   : Register
    Created on : Apr 20, 2017, 3:18:28 PM
    Author     : oracle
--%>
...
<div class="">
	<div class="row">
		<h3 class="text-center ">Creare cont</h3> 
        <form class="form-horizontal">
<fieldset class="text-left">

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Nume de utilizator</label>  
  <div class="col-md-6">
  <input id="textinput" name="textinput" placeholder="Ion Popescu" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="textinput" name="textinput" placeholder="ion.popescu@gmail.com" class="form-control input-md" required="" type="text">
  <span class="help-block"> </span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="textinput" name="textinput" placeholder="parola" class="form-control input-md" required="" type="password">
  <span class="help-block"> </span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <button id="singlebutton" name="singlebutton" class="btn btn-success">Creeaza cont</button>
  </div>
</div>
