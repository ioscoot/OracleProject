<%-- 
    Document   : HomePage
    Created on : Apr 20, 2017, 2:39:07 PM
    Author     : oracle
--%>
...
#footer a {
	...
	<div id="page-bgbtm">
		<div id="content">
			<div class="post">
				<h2 class="title">Iepurasul nazdravan</h2>
				...
				<div style="clear: both;">
                    <div class="content">
                        ...
                        <div class="excerpt"> Iepurașul se arată dispus să viziteze, în 2017, o treime dintre firmele private, arată un studiu realizat de eJobs, cea mai mare platformă de recrutare online din România. Anumiți... </div>
                        <div class="more mg-top-10"> <a  href="#">citeste tot articolul</a> </div>
                    </div>
                </div>
				
				<h2 class="title">Președintele Bashar al-Assad</h2>
				<p class="meta"><span class="date">13 Aprilie 2017</span><span class="posted">Posted by <a href="#">
				Alina<span class="auto-style4"></span></a></span></p>
				<div style="clear: both;">
                    <div class="content">
                        <div class="date">13 Apr 2017</div> 
                        <div class="excerpt"> Președintele Bashar al-Assad susține că atacul chimic asupra unui oraș rebel din țara sa este o “fabricație 100%”. Liderul de la Damasc consideră că acest atac, soldat cu peste 80 de... </div>
                        <div class="more mg-top-10"> <a  href="#">citeste tot articolul</a> </div>
                    </div>
                </div>
				
				<h2 class="title">Președintele Klaus Iohannis</h2>
				<p class="meta"><span class="date">13 Aprilie 2017</span><span class="posted">Posted by <a href="#">
				Alina<span class="auto-style4"></span></a></span></p>
				<div style="clear: both;">
                    <div class="content">
                        <div class="date">13 Apr 2017</div> 
                        <div class="excerpt"> Copiii sub 3 ani vor fi scoși de la plata întreținerii. Președintele Klaus Iohannis a promulgat joi, 13 aprilie, legea.  Preşedintele Klaus Iohannis a promulgat, joi, legea pentru... </div>
                        <div class="more mg-top-10"> <a  href="#">citeste tot articolul</a> </div>
                    </div>
                </div>
